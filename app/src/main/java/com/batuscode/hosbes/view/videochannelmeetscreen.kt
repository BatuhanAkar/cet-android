...
@Composable
fun VideoChannelMeetScreen(videoChannelViewModel: VideoChannelViewModel){
                ...
                )
                {
                    OutlinedIconButton(
                        onClick = {
                            ...
                            videoChannelViewModel.update_videochannelAudioMute(audioMuted)
                        } ,
                        border = null ,
...
@Composable
fun VideoChannelMeetScreenPreview(){
    HoşbeşTheme {
        VideoChannelMeetScreen(VideoChannelViewModel())
    }
}